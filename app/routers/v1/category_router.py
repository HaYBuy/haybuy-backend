...
async def create_category(
    ...
    db_category = Category(
        name=category.name, slug=category.slug, parent_id=category.parent_id or None
    )
    db.add(db_category)
    db.commit()
...
@router.get("/{category_id}", response_model=CategoryChainResponse)
