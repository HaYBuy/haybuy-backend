...
from ...schemas.category_schema import CategoryBase, CategoryCreate, CategoryResponse, CategoryUpdate
...
@rounter.get("/{category_id}", response_model=CategoryResponse)
